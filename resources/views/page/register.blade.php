            ...
            <div class="row">
              <div class="site site--main">
                ...
                <div class="site__panel">
                 <!--  <span class="site__header-text">Flexible configuration and editing forms, add and edit listing information, photos and location of the position</span> -->
                </div>
<!-- @if (count($errors) > 0)
...
<!--                   <form class="form form--flex form--property-add js-form js-form-property">
 -->                  <form  class="form form--flex form--property-add js-form js-form-property" method="post" id="registerform" action="/registerSave" enctype="multipart/form-data">
  {{csrf_field()}}
