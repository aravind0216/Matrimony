        ...
        <nav class="breadcrumbs">
          <div class="container">
            <ul>
              ...
              <li class="breadcrumbs__item"><a href="" class="breadcrumbs__link">View Profile</a></li>
            </ul>
          </div>
        </nav>
...
<form  class="form form--flex form--property-add js-form js-form-property" method="post" id="registerform" action="/registerUpdate" enctype="multipart/form-data">
  {{csrf_field()}}
        ...
        <div class="widget__content">
          <div class="row">
            ...
            <!-- <div class="form-group">
              ...
              <input value="<?php //echo $row->password; ?>" id="password" name="password" type="password" placeholder="" class="form-control">
            ...
            <div class="form-group">
              ...
              <select id="religion" name="religion" data-placeholder="-Select-" class="form-control js-in-select">
                ...
                <option <?php if ($row->religion == 1) { echo ' selected="selected"'; } ?> value="1">Hindu</option>
                <!-- <option <?php //if ($row->religion == 2) { echo ' selected="selected"'; } ?> value="2">Christian</option>
                <option <?php //if ($row->religion == 3) { echo ' selected="selected"'; } ?> value="3">Muslim</option> -->
              </select>
            </div>
            <div class="form-group">
                ...
                <option>All Vellala Pillai Mudaliar</option>
                          ...
                          <div class="form-group">
                            ...
                            <select id="empolyedin" name="empolyedin" data-placeholder="-Select-" class="form-control js-in-select">
                              <option value="">-Select-</option>
                              <option <?php if ($row->education == 'Government') { echo ' selected="selected"'; } ?>>Government</option>
                              <option <?php if ($row->education == 'Private') { echo ' selected="selected"'; } ?>>Private</option>
                              <option <?php if ($row->education == 'Busisness') { echo ' selected="selected"'; } ?>>Busisness</option>
                              <option <?php if ($row->education == 'Not Working') { echo ' selected="selected"'; } ?>>Not Working</option>
                            </select>
                          </div>
                      ...
                      <div class="widget__content">
                        <div class="row">
                          ...
                          <div class="form-group">
                            ...
                            <input value="<?php echo $row->mobile; ?>" type="text" name="mobile" id="mobile" class="form-control">
                          </div>
