                                          ...
                                          <div class="info__list">
                                            <div class="info__column">
                                              <div class="info__item">
                                                <div class="info__title">Total Transaction</div>
                                            ...
                                            <div class="info__column">
                                              <div class="info__item">
                                                <div class="info__title">Total Viewd Profile</div>
                                                <div class="info__value">{{$viewed}}</div>
                                                <!-- <div class="info__trend info__trend--negative">Down 1%<i class="fa fa-arrow-down"></i></div> -->
                                              </div>
                                            </div>
                                            <!-- <div class="info__column">
                                              <div class="info__item">
                                                <div class="info__title">Total liked</div>
                                                <div class="info__value">3,922</div>
                                              </div>
                                            </div> -->
                                          </div>
                                        </section>
